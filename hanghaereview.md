...
확실히 미니 프로젝트와 클론코딩은 기본적인 CRUD배포 정도였었는데, 
실전프로젝트 같은 경우에는 일단 다른 기수 실전 프로젝트도 많이 참조하였으며, 
basic한 단계를 좀 더 벗어나 심화된 기술을 많이 넣으려고 노력하였다. 
...
실전 프로젝트가 끝나고 몇개월 더 공부를 하고 취업 준비를 하려고 했는데..  
...
99일이라는 시간동안
나 자신과 싸움을 하면서 
머리도 많이 쥐어 뜯고, 좌절도 많이 했다.  

조금씩 조금씩 성장하는 나를 보았으며,   
짧은 시간이였지만 인생에서 내가 이렇게 몰두 해본적이 있나 싶다. 

그리고 항해가 끝난지 이제 거의 한달이 다되가지만, 
취업을 하고도 공부는 끝이 없다.
현재는 사실 자바가 아닌 다른 프로그램을 배우고 있어서 
다시 새롭고 짜릿하지만 , 모르는것이라 해서 두려웠던건 없었다. 
공부하는 습관이 잘 만들어진것이 정말 만족스럽다. 
계속 여기에 안주하지 않고 쭉 성장하는 개발자가 되고 싶다. 
